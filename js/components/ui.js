...
const ICON_PATHS = {
  ...
  settings: '<circle cx="12" cy="12" r="3"/><path d="M10 2h4l.5 2.2 1.6.7 1.9-1.2 2.8 2.8-1.2 1.9.7 1.6 2.2.5v4l-2.2.5-.7 1.6 1.2 1.9-2.8 2.8-1.9-1.2-1.6.7L14 22h-4l-.5-2.2-1.6-.7-1.9 1.2-2.8-2.8 1.2-1.9-.7-1.6L1.5 14v-4l2.2-.5.7-1.6-1.2-1.9L6 3.2l1.9 1.2 1.6-.7L10 2Z"/>',
};
